...
function MasterclassDetails() {
  ...
  // Fetch registration fees — wiring unchanged.
  useEffect(() => {
      ...
      <div className="min-h-screen bg-surface-canvas pt-32">
        <Container>
          ...
          <div className="flex flex-col gap-5 max-w-prose border-l-2 border-marigold pl-8 py-8">
            <Eyebrow withRule>{t("pageCopy.masterclassDetails.importantLabel")}</Eyebrow>
          ...
          >
            ...
            <div className="lg:col-span-6 flex flex-col gap-6">
              <motion.div variants={fadeUpSoft}>
                <Eyebrow withRule>{t("pageCopy.masterclassDetails.eyebrow")}</Eyebrow>
              </motion.div>
              <motion.h1
                variants={fadeUp}
              ...
              >
                ...
                {Array.isArray(event.event_duration) &&
                  event.event_duration.length > 0 && (
                    <MetaItem label={t("eventDetails.eventDuration")}>
                      {event.event_duration.join(" / ")} minutes
                    </MetaItem>
                  )}
      ...
      {instructor && (
        <Section tone="canvas" pause="md" rule="top">
          <Container>
            ...
            >
              <Eyebrow withRule>{t("pageCopy.masterclassDetails.instructorEyebrow")}</Eyebrow>
...
/* ============================================================================
   InstructorCard — full editorial spread for the single instructor
   ============================================================================ */
