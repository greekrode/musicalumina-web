...
export const translations = {
  en: {
    ...
    registration: {
      ...
      videoUrlHelp: "Provide a link to your performance video (YouTube, Google Drive, etc.). Make sure it's public and accessible.",
  ...
  id: {
    ...
    registration: {
      ...
      videoUrl: "URL Video",
      videoUrlPlaceholder: "https://youtube.com/watch?v=...",
      videoUrlHelp: "Berikan tautan ke video penampilan Anda (YouTube, Google Drive, dll.). Pastikan video tersebut publik dan dapat diakses.",
